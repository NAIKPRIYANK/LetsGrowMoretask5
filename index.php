            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="find-result.php">Result</a></li>
...
<?php }} ?>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white"> Student Result Management System Design and Code by PRIYANK <?php echo date('Y');?></p></div>
        </footer>
        <!-- Bootstrap core JS-->
